...
ylim([-40,40])
zlim([0,60])
for i=1:1:51 atj=Rbt.fkine(sqtraj1(i,:)); jta=transpose(atj); JTA(i,:)=jta(4,1:3); jta=JTA; plot2(jta(i,:),'r.'); Rbt.plot(sqtraj1(i,:)); plot2(JTA,'b')
end
for i=1:1:51 atj2=Rbt.fkine(sqtraj2(i,:)); jta2=transpose(atj2); JTA2(i,:)=jta2(4,1:3); jta2=JTA2; plot2(jta2(i,:),'r.'); Rbt.plot(sqtraj2(i,:)); plot2(JTA2,'b')
end
for i=1:1:51 atj3=Rbt.fkine(sqtraj3(i,:)); jta3=transpose(atj3); JTA3(i,:)=jta3(4,1:3); jta3=JTA3; plot2(jta3(i,:),'r.'); Rbt.plot(sqtraj3(i,:)); plot2(JTA3,'b')
end
for i=1:1:51 atj4=Rbt.fkine(sqtraj4(i,:)); jta4=transpose(atj4); JTA4(i,:)=jta4(4,1:3); jta4=JTA4; plot2(jta4(i,:),'r.'); Rbt.plot(sqtraj4(i,:)); plot2(JTA4,'b')
end
for i=1:1:51 atj5=Rbt.fkine(sqtraj5(i,:)); jta5=transpose(atj5); JTA5(i,:)=jta5(4,1:3); jta5=JTA5; plot2(jta5(i,:),'r.'); Rbt.plot(sqtraj5(i,:)); plot2(JTA5,'b')
end
for i=1:1:51 atj6=Rbt.fkine(sqtraj6(i,:)); jta6=transpose(atj6); JTA6(i,:)=jta6(4,1:3); jta6=JTA6; plot2(jta6(i,:),'r.'); Rbt.plot(sqtraj6(i,:)); plot2(JTA6,'b')
end
% for i=1:1:51
